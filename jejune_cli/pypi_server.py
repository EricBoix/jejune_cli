"""PyPI availability check for the `pypi-server` doctor component."""
...
def check_pypi_server(timeout: int = 5) -> tuple[bool, str]:
...
def is_pypi_server_available() -> bool:
    return check_pypi_server()[0]
